...
Write-Host "`n🔧 Atualizando Quest4You para domínio independente (quest4you.site)..." -ForegroundColor Cyan
Write-Host "=" * 60
...
Write-Host "🌐 Domínio: quest4you.site" -ForegroundColor Cyan
Write-Host "`nPróximos passos:"
Write-Host "  1. cd '$projectPath'"
Write-Host "  2. npx vercel --prod"
Write-Host "  3. Configurar domínio quest4you.site no Vercel"
